...
export default function AdminDashboard() {
  ...
  return <div className="max-w-7xl text-slate-700"><div className="mb-8 flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm font-medium text-green-700">Operations overview</p><h1 className="text-3xl font-semibold">Dashboard</h1></div><div className="flex flex-wrap gap-2 text-sm"><a href="/api/admin/reports/dashboard" className="rounded-lg border bg-white px-3 py-2">Export Dashboard PDF</a><a href="/api/admin/reports/orders" className="rounded-lg border bg-white px-3 py-2">Export Orders PDF</a><a href="/api/admin/reports/customers" className="rounded-lg border bg-white px-3 py-2">Export Customers PDF</a><a href="/api/admin/manual" className="rounded-lg bg-slate-800 px-3 py-2 text-white">Download Admin Manual</a></div></div>
